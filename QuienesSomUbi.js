  ...
  render() {
    return (
      <View style={{ height: '100%', width: '100%', borderColor: 'red', borderWidth: 0, backgroundColor:'#eeeeee'}}>
        <View style={{ height: '35%', width:'95%', borderColor: 'blue', borderWidth: 0, backgroundColor:'#7b0000', marginLeft:10, marginTop:10}}></View>
        <Image source={require('./fotos/Mapa2.png')} style={{borderColor: 'white', borderWidth: 0, height: '25%', width:'75%', marginTop:'-65%', borderRadius:7, marginLeft:50,}}></Image>
        ...
        <Text  style={{color: 'white', fontWeight: 'bold', fontSize:15, marginLeft:80, borderColor: 'white', borderWidth: 0, width:250, height: 25, marginTop:15}}>Localizar domicilio en Google Maps</Text>
        <Image source={require('./fotos/ico2.png')} style={{ borderColor: 'white', borderWidth: 0, height: 25, width:25, marginLeft:55, marginTop:-25}}></Image>
        </TouchableOpacity>
        ...
        <View style={{ height: '24%', width: '90%', borderColor: 'red', borderWidth: 0, marginTop: 10, marginLeft:'5%'}}>
          <ScrollView>
            <Text style={{color: 'black', fontSize:16, lineHeight: 25, textAlign: 'justify',  height: '100%', width: '100%'}}>
              ...
              <TouchableOpacity style={{ borderColor: 'red', borderWidth:0, width:150, height: 25, marginLeft:10}}><Text onPress={()=>{Linking.openURL('tel:(01 33) 3836 4530');}} style={{fontSize:16, color: 'darkslateblue'}}>(01 33) 3836 4530</Text></TouchableOpacity>
              <TouchableOpacity style={{ borderColor: 'red', borderWidth:0, width:150, height: 25, marginLeft:10, marginTop:10}}><Text onPress={()=>{Linking.openURL('tel:(33)3619 0480')}} style={{fontSize:16, color: 'darkslateblue'}}>33 3619 0480</Text></TouchableOpacity>
              <Text style={{color: '#7b0000'}}>{"\n"}Correos electrónicos{"\n"}</Text>
              <TouchableOpacity style={{ borderColor: 'red', borderWidth:0, width:150, height: 25, marginLeft:10, marginTop:10}}><Text onPress={()=>{Linking.openURL('mailto: bpej@udg.mx')}} style={{fontSize:16, color: 'darkslateblue'}}>bpej@udg.mx</Text></TouchableOpacity>
              <TouchableOpacity style={{ borderColor: 'red', borderWidth:0, width:200, height: 25, marginLeft:10, marginTop:10}}><Text onPress={()=>{Linking.openURL('mailto: bibliojalisco@gmail.com')}} style={{fontSize:16, color: 'darkslateblue'}}>bibliojalisco@gmail.com</Text></TouchableOpacity>
            </Text>
          </ScrollView>
        </View>
