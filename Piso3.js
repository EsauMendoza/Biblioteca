...
export default class Piso1 extends Component {
  ...
  render() {
    return (
        ...
        <TouchableOpacity activeOpacity={1} style={{ borderColor: 'blue', borderWidth:0, width:390, height: 70, backgroundColor:'white', marginTop: 20, marginLeft:10,borderRadius:5}}>
          <Text style={{color: 'darkred', fontSize:12.5,fontWeight:'bold', marginLeft:80, borderColor: 'red', borderWidth: 0, width:250, height: 40, marginTop: 10}}>4.1 Publicaciones Seriadas de Jalisco (Del S.XIX hasta 1982)</Text>
