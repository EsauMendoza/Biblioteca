    ...
    return (
      <View style={{ height: '100%', width: '100%', borderColor: 'red', borderWidth: 0, backgroundColor:'#eeeeee'}}>
        ...
        <View style={{ height: '100%', width: '86.5%', borderColor: 'red', borderWidth: 0, marginTop: 10, marginLeft:'5%'}}>
          <Text style={{color: 'black', fontSize:18, lineHeight: 25, textAlign: 'justify',  height: '100%', width: '100%'}}>Definir a la Biblioteca Pública del Estado de Jalisco envuelve la consideración y explicación de dos aspectos fundamentales. Primero, el contexto nacional e histórico que dio vida a nuestra biblioteca y la dotó de capacidades propias de una época por demás convulsa y que dejó huellas imborrables en la institución. Segundo, el papel de la globalización y las tecnologías que caracterizan a la época actual que ha conllevado a una transición de la biblioteca cuyo objetivo es cubrir las necesidades de una comunidad en general, adecuándose a dichas tendencias.
          En América, México juega un papel destacado en lo que se refiere a las tradiciones culturales y antiguas en el continente. Desde la época prehispánica, en el país ya existían las casas de los libros, conocidas como amoxcalli, cuya función era conservar los manuscritos. Además existen referencias de que fue el primer país que fundó oficialmente una biblioteca en 1534, es así como durante la época de la Colonia México se fue posicionando como poseedor de las bibliotecas más ricas y grandes de la América española.</Text>
        </View>
        </ScrollView>
