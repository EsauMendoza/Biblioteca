  ...
  render() {
    return (
      <View style={{ height: '100%', width: '100%', borderColor: 'red', borderWidth: 0, backgroundColor:'#eeeeee'}}>
        ...
        <Image source={require('./fotos/Libreria4.jpg')} style={{borderColor: 'white', borderWidth: 0, height: '20%', width:'60%', marginTop:-180, borderRadius:7, marginLeft:80,}}></Image>
        ...
        <Text style={{fontWeight: 'bold', color: 'black', fontSize:15, marginLeft:70, borderColor: 'red', borderWidth: 0, width:100, height: 20, marginTop:-20}}>Presentacion</Text>
        ...
        <View style={{ height: '35%', width: '86.5%', borderColor: 'red', borderWidth: 0, marginTop: 10, marginLeft:'5%'}}>
        ...
        <TouchableOpacity activeOpacity={1} style={{ borderColor: 'blue', borderWidth: 0, height: '3%', width:'60%',marginLeft:'5%'}}>
        ...
        <Image source={require('./fotos/Logo.png')} style={{ borderColor: 'red', borderWidth: 0, height: '10%', width:'60%', marginLeft:'5%', marginTop:'2%'}}></Image>
      </View>
    )
  }
}
