  ...
  render() {
    return (
      <View style={{ height: '100%', width: '100%', borderColor: 'blue', borderWidth: 0, backgroundColor:'gainsboro'}}>
        ...
        <TouchableOpacity activeOpacity={1} style={{ borderColor: 'blue', borderWidth:0, width:'96%', height: 70, backgroundColor:'white', marginTop: 30, marginLeft:10,borderRadius:5}}>
        ...
        <TouchableOpacity activeOpacity={1} style={{ borderColor: 'blue', borderWidth:0, width:'96%', height: 70, backgroundColor:'white', marginTop: 20, marginLeft:10,borderRadius:5}}>
          <Text style={{color: 'darkred', fontSize:12.5,fontWeight:'bold', marginLeft:80, borderColor: 'red', borderWidth: 0, width:'65%', height: 70, marginTop: '3%'}}>Piso 4. Publicaciones seriadas de Jalisco (Del S.XIX hasta 1982) y Fonoteca</Text>
          <Image source={require('./fotos/Libreria.jpg')} style={{ borderColor: 'blue', borderWidth: 0, height: 50, width:50, marginTop:'-21%', borderRadius:7, marginLeft:10,}}></Image>
          <Image source={require('./fotos/ico1.png')} style={{marginLeft:'89%', borderColor: 'blue', borderWidth: 0, width:30, height: 30, marginTop:-40}}></Image>
        </TouchableOpacity>

        <TouchableOpacity activeOpacity={1} style={{ borderColor: 'blue', borderWidth:0, width:'96%', height: 70, backgroundColor:'white', marginTop: 20, marginLeft:10,borderRadius:5}}>
          <Text style={{color: 'darkred', fontSize:12.5,fontWeight:'bold', marginLeft:80, borderColor: 'red', borderWidth: 0, width:'63%', height: 60, marginTop: '3%'}}>Piso 5. Acervo General, Fondos Particulares, Cinemateca y Fototeca de Jalisco</Text>
          <Image source={require('./fotos/Libros3.jpg')} style={{ borderColor: 'blue', borderWidth: 0, height: 50, width:50, marginTop:'-17%', borderRadius:7, marginLeft:10,}}></Image>
          <Image source={require('./fotos/ico1.png')} style={{marginLeft:'89%', borderColor: 'blue', borderWidth: 0, width:30, height: 30, marginTop:-40}}></Image>
        </TouchableOpacity>
